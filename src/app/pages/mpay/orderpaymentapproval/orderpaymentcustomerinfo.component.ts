...
@Component({
    ...
    selector: 'app-orderpayment-customer-info',
    templateUrl: './orderpaymentcustomerinfo.component.html',
})


export class OrderPaymentCustomerInfoComponent implements OnInit, AfterViewInit {
