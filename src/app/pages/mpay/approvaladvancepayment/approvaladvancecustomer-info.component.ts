...
@Component({
    ...
    selector: 'app-approval-addvance-customer-info',
    templateUrl: './approvaladvancecustomer-info.component.html',
    styleUrls: ['./approvaladvancecustomer-info.component.scss']
})


export class ApprovalAdvanceCustomerInfoComponent implements OnInit, AfterViewInit {
