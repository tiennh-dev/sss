...
@Injectable()
export class PurchaseReportAucService {

    constructor(private http: HttpClientService) { }
    GetListPurchaseReportAuc(): Observable<BaseEntityResponse<PurchaseReportView[]>> {
        const url = ConfigSetting.GET_PURCHASE_REPORT_AUC;
    ...
    GetPurchaseReportDataAuc(request:PurchaseReportMercariRequest): Observable<BaseEntityResponse<PurchaseReportData[]>> {
        const url = ConfigSetting.GET_PURCHASE_REPORT_DATA_AUC;
    ...
    Export(request:PurchaseReportRequest): Observable<BaseResponse> {
        const url = ConfigSetting.EXPORT_ORDER_PURCHASE_REPORT_AUC;
