...
@Component({
    selector: 'app-process-deposite-processing',
    templateUrl: './processdeposits.process.component.html',
})

export class ProcessDepositeProcessingdepComponent implements OnInit {
    ...
    constructor(private modalService: NgbModal, private ctService: ProcessDepositsService, public activeModal: NgbActiveModal,
