...
@Component({
    selector: 'app-mpay-orderpaidaddpayment',
    templateUrl: './orderpaidaddpayment.component.html'
})

export class OrderPaidAddPaymentComponent implements OnInit, OnDestroy {
