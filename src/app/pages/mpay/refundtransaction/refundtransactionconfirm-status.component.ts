...
@Component({
    selector: 'app-refund-transaction-confirm-status',
    templateUrl: './refundtransactionconfirm-status.component.html'
})

export class RefundTransactionStatusComponent implements OnInit, OnDestroy {
    ...
    constructor(private _service: RefundTransactionService,
