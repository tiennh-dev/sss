...
@Component({
    selector: 'app-process-deposit-confirm-status',
    templateUrl: './processdeposite-confirm-status.component.html'
})

export class ProcessDepositeConfirmStatusComponent implements OnInit, OnDestroy {
    ...
    constructor(private _service: ProcessDepositsService,
