...
@Component({
  selector: 'app-acceptorderpaymentapprovalmulti',
  templateUrl: './acceptorderpaymentapproval.component.html'
})

export class AcceptOrderPaymentApprovalComponent implements OnInit {
    @Input() listOrderId;
    public listData: any[] = [];
