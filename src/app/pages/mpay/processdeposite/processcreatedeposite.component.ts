...
@Component({
    selector: 'app-process-create-deposite',
    templateUrl: './processcreatedeposite.component.html'
})

export class ProcessCreateDepositeComponent implements OnInit, OnDestroy {
