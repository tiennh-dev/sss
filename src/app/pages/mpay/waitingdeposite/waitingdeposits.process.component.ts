...
@Component({
    selector: 'app-waiting-deposite-processing',
    templateUrl: './waitingdeposits.process.component.html',
})

export class WaitingDepositeProcessingdepComponent implements OnInit {
    ...
    constructor(private modalService: NgbModal, private ctService: WaitingDepositsService, public activeModal: NgbActiveModal,
