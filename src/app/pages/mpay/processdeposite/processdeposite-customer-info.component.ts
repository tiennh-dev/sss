...
@Component({
    ...
    selector: 'app-process-deposite-customer-info',
    templateUrl: './processdeposite-customer-info.component.html'
})


export class ProcessDepositeCustomerInfoComponent implements OnInit, AfterViewInit {
    ...
    constructor(public activeModal: NgbActiveModal,
        private orderService: ProcessDepositsService,
