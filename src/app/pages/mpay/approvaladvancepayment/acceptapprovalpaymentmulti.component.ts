...
@Component({
  selector: 'app-accept-approval-payment-multi',
  templateUrl: './acceptapprovalpaymentmulti.component.html'
})

export class AcceptApprovalPaymentMultiComponent implements OnInit {
    @Input() listOrderId;
