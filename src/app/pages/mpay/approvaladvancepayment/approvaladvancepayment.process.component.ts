...
@Component({
    ...
    selector: 'mpay-approval-advance-payment-process',
    templateUrl: './approvaladvancepayment.process.component.html',
    styleUrls: ['./approvaladvancepayment.process.component.scss']
})


export class ApprovalAdvancePaymentProcessComponent implements OnInit {
    ...
    constructor(public activeModal: NgbActiveModal,
        private orderService: ApprovalAdvancePaymentService, private modalService: NgbModal,
    ...
    addPaymentOpenModel(): void {
        const modalRef = this.modalService.open(ApprovalAddPaymentComponent);
