...
@Component({
    ...
    selector: 'refund-transaction-customer-info',
    templateUrl: './RefundTransactionCustomerInfo.Component.html'
})


export class RefundTransactionCustomerInfoComponent implements OnInit, AfterViewInit {
    ...
    constructor(public activeModal: NgbActiveModal,
        private orderService: RefundTransactionService,
