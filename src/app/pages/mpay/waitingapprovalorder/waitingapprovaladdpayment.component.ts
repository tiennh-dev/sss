...
@Component({
    selector: 'app-mpay-witing-addpayment',
    templateUrl: './waitingapprovaladdpayment.component.html'
})

export class WaitingApprovalAddPaymentComponent implements OnInit, OnDestroy {
