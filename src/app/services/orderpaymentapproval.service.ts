...
import { OrderWorkflowRequest, OrderMessageGetByOrderIdRequest, OrderWorkflowManyRequest, OrderPaymentsRequest, OrderPaysRequest } from '../models/request/order.request';
...
@Injectable()
export class OrderPaymentApprovalService {
    constructor(private http: HttpClientService) { }

    getListJTable(request: any): Observable<DataTableResponse<model.OrderJTable>> {
        const url = ConfigSetting.ORDER_PAYMENT_APPROVAL_LIST_JTABLE;
    ...
    getOrderDetail(request: any): Observable<BaseEntityResponse<model.OrderDetailList[]>> {
        const url = ConfigSetting.ORDER_PAYMENT_APPROVAL_DETAIL;
    ...
    getOrderDetailPayment(id: number, accountId: string): Observable<BaseEntityResponse<model.OrderDetailPayment>> {
        const url = ConfigSetting.ORDER_PAYMENT_APPROVAL_DETAIL_PAYMENT;
    ...
    getListCustomer(): Observable<resCus.CustomerListResponse> {
        const url = ConfigSetting.ORDER_PAYMENT_APPROVAL_LIST_CUSTOMER;
    ...
    getListTopCustomer(request: reqCus.CustomerListTopRequest): Observable<BaseEntityResponse<modelCus.CustomerList[]>> {
        const url = ConfigSetting.ORDER_PAYMENT_APPROVAL_LIST_TOP_CUSTOMER;
    ...
    getDetail(orderId: number): Observable<BaseEntityResponse<model.OrderApp>> {
        const url = ConfigSetting.ORDER_PAYMENT_APPROVAL_GET_DETAIL;
    ...
    approvedCancelOrder(request: OrderWorkflowRequest): Observable<WorkflowTriggerInfoResponse> {
        const url = ConfigSetting.APPROVAL_ORDER_APPROVED_CANCEL_ORDER;
    ...
    getMessages(request: OrderMessageGetByOrderIdRequest): Observable<BaseEntityResponse<model.OrderMessage[]>> {
        const url = ConfigSetting.ORDER_PAYMENT_APPROVAL_GET_MESSAGES;
    ...
    AddPayment(request: PaymentAddRequest): Observable<resCus.CustomerListResponse> {
        const url = ConfigSetting.ORDER_PAYMENT_APPROVAL_PAYMENT_ADD_REQUEST;
        return this.http.postAuthorize<resCus.CustomerListResponse>(url, request);
    }
    getPaymentProfile(accountId: string): Observable<number> {
        const url = ConfigSetting.ORDER_PAYMENT_APPROVAL_GET_PAYMENT_PROFILE;
        return this.http.postAuthorize<number>(url + '/' + accountId, null);
    }
    getwallets(): Observable<BaseEntityResponse<WalletList[]>> {
        const url = ConfigSetting.ORDER_PAYMENT_APPROVAL_GET_WALLETS;
    ...
    rejectCancelOrder(request: OrderWorkflowRequest): Observable<WorkflowTriggerInfoResponse> {
        const url = ConfigSetting.ORDER_PAYMENT_APPROVAL_REJECT_CANCEL_ORDER;

        return this.http.postAuthorize<WorkflowTriggerInfoResponse>(url, request);
    }

    rejectRequestApproveTempDeposit(request: OrderWorkflowRequest): Observable<WorkflowTriggerInfoResponse> {
        const url = ConfigSetting.ORDER_PAYMENT_APPROVAL_REJECT_REQUEST_APPROVE_TEMPDEPOSIT;

        return this.http.postAuthorize<WorkflowTriggerInfoResponse>(url, request);
    }

    approveTempDeposit(request: OrderWorkflowRequest): Observable<WorkflowTriggerInfoResponse> {
        const url = ConfigSetting.ORDER_PAYMENT_APPROVAL_TEMP_DEPOSIT;

        return this.http.postAuthorize<WorkflowTriggerInfoResponse>(url, request);
    }

    customerRejectPayment(request: OrderWorkflowRequest): Observable<WorkflowTriggerInfoResponse> {
        const url = ConfigSetting.ORDER_PAYMENT_APPROVAL_CUSTOMER_REJECT_PAYMENT;
    ...
    approvePaymentOrderMulti(request: OrderWorkflowManyRequest): Observable<WorkflowTriggerInfoResponse> {
        const url = ConfigSetting.APPROVAL_ORDER_APPROVE_PAYMENT_ORDER_MULTI;

        return this.http.postAuthorize<WorkflowTriggerInfoResponse>(url, request);
    }

    rejectPaymentOrder(request: OrderWorkflowRequest): Observable<WorkflowTriggerInfoResponse> {
        const url = ConfigSetting.APPROVAL_ORDER_REJECT_PAYMENT_ORDER;

        return this.http.postAuthorize<WorkflowTriggerInfoResponse>(url, request);
    }

    approvePaymentOrderDone(request: OrderWorkflowRequest): Observable<WorkflowTriggerInfoResponse> {
        const url = ConfigSetting.ORDER_PAYMENT_APPROVAL_DONE;

        return this.http.postAuthorize<WorkflowTriggerInfoResponse>(url, request);
    }
    loadCustomerInfo(accountId: string): Observable<BaseEntityResponse<modelCus.Customer>> {
        const url = ConfigSetting.ORDER_PAYMENT_APPROVAL_GET_CUSTOMER_INFO;
    ...
    getWalletInfo(accountId: string): Observable<CustomerWalletInfoResponse> {
        const url = ConfigSetting.ORDER_PAYMENT_APPROVAL_GET_WALLET_INFO;
    ...
    getMembershipInfo(accountId: number): Observable<MemberShipLevel> {
        const url = ConfigSetting.ORDER_PAYMENT_APPROVAL_GET_MEMBERSHIP_INFO;
    ...
    getEmpInfo(accountId: string): Observable<BaseEntityResponse<EmployeeDetail>> {
        const url = ConfigSetting.ORDER_PAYMENT_APPROVAL_GET_EMP_INFO;
    ...
    getListOrder(request: model.OrderList): Observable<model.OrderJTable> {
        const url = ConfigSetting.ORDER_PAYMENT_APPROVAL_GET_LIST_ORDER;
    ...
    RequestApproveMany(request: OrderWorkflowManyRequest): Observable<BaseResponse> {
        const url = ConfigSetting.ORDER_PAYMENT_APPROVAL_TEMP_DEPOSITE_MULTI;
        return this.http.post<BaseResponse>(url ,request);
    }

    getEmployeeBySale():Observable<BaseResponse> {
        const url = ConfigSetting.ORDER_PAYMENT_APPROVAL_GET_EMPLOYEE_SALER;
        return this.http.post<BaseResponse>(url ,null);
    }
    getOrderPayments(request: OrderPaymentsRequest): Observable<model.OrderJTable> {
        const url = ConfigSetting.ORDER_PAYMENT_APPROVAL_GET_ORDER_PAYMENTS;
        return this.http.post<model.OrderJTable>(url, request);
    }

    payOrders(request: OrderPaysRequest): Observable<BaseResponse> {
        const url = ConfigSetting.ORDER_PAYMENT_APPROVAL_PAY_ORDERS;
        return this.http.post<BaseResponse>(url, request);
    }

    exportExcel(request:any):Observable<BaseResponse>{
        const url = ConfigSetting.GET_EXPORT_ORDER_PAYMENT_APPROVAL;
