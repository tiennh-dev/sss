...
@Component({
    ...
    selector: 'app-waiting-approval-customer-info',
    templateUrl: './waitingapprovalcustomer-info.component.html',
    styleUrls: ['./waitingapprovalcustomer-info.component.scss']
})


export class WaitingApprovalCustomerInfoComponent implements OnInit, AfterViewInit {
