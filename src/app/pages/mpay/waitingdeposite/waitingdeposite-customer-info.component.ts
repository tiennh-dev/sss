...
@Component({
    ...
    selector: 'app-waiting-deposite-customer-info',
    templateUrl: './waitingdeposite-customer-info.component.html'
})


export class WaitingDepositeCustomerInfoComponent implements OnInit, AfterViewInit {
    ...
    constructor(public activeModal: NgbActiveModal,
        private orderService: WaitingDepositsService,
