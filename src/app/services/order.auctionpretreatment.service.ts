...
@Injectable()
export class OrderAuctionPretreatmentService {
    constructor(private http: HttpClientService) { }

    getListJTable(request: any): Observable<DataTableResponse<model.OrderJTable>> {
        const url = ConfigSetting.ORDER_AUCTION_PRETREATMENT_LIST_JTABLE;
    ...
    getProductOrigin(): Observable<BaseEntityResponse<ProductOrigin[]>> {
        const url = ConfigSetting.ORDER_AUCTION_PRETREATMENT_GET_ALL_PRODUCT_ORIGIN;
    ...
    UpdateProductType(id:number,producttype:string): Observable<BaseResponse> {
        const url = ConfigSetting.ORDER_AUCTION_PRETREATMENT_UPDATE_PRODUCT_TYPE;
    ...
    UpdateProductOrigin(id:number,productorigin:string): Observable<BaseResponse> {
        const url = ConfigSetting.ORDER_AUCTION_PRETREATMENT_UPDATE_PRODUCT_ORIGIN;
    ...
    exportExcel(request:any):Observable<BaseResponse>{
        const url = ConfigSetting.GET_EXPORT_AUC_PRE;
