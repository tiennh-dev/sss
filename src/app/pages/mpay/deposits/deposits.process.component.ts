...
@Component({
    ...
    templateUrl: './deposits.process.component.html',
})

export class TransactionProcessingdepComponent implements OnInit {
    ...
    constructor(private modalService: NgbModal, private ctService: DepositsService, public activeModal: NgbActiveModal,
