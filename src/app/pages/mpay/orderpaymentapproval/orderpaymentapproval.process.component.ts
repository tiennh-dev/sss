...
@Component({
    ...
    selector: 'mpay-orderpayment-approval-process',
    templateUrl: './orderpaymentapproval.process.component.html',
    styleUrls: ['./orderpaymentapproval.process.scss']
})


export class OrderPaymentProcessComponent implements OnInit {
    ...
    constructor(public activeModal: NgbActiveModal,
        private orderService: OrderPaymentApprovalService, private modalService: NgbModal,
    ...
    addPaymentOpenModel(): void {
        const modalRef = this.modalService.open(CreatePaymentComponent);
        ...
        modalRef.componentInstance.debtVND = this.order.orderPaymentDetail.debtVND;
